...
- **Share Extension** (Android `MemosShareExtension` / macOS `MemosShareExtension`): handles `ACTION_SEND`/share-services intent to create a new memo pre-filled with shared text/URL.
